...
const ProtfolioContainer = styled.div`
  padding: ${({ style }) =>
...
const ProtfolioButtonText = styled.p`
...
`;
  ...
  return (
    <ProtfolioContainer id={id} style={style}>
      <div
        style={{
          maxWidth: "96rem",
          margin: "0 auto",
                ...
                <ProtfolioWrapper key={index}>
                  ...
                  >
                    ...
                    >
                      ...
                      <ProtfolioButtonText>SEE MORE</ProtfolioButtonText>
                    </div>
                  </div>
                </ProtfolioWrapper>
              )
