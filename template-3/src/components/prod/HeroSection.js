          ...
          <div className="flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex items-center justify-center gap-4">
              <button
                ...
                className="text-white rounded-2xl bg-[#b9ff81] px-6 text-sm font-medium py-2"
              >
              ...
              <button
                ...
                className="border border-[#b9ff81] bg-transparent px-6 rounded-2xl text-[#b9ff81] text-sm font-medium py-2"
              >
