  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center py-20 sm:py-24 gap-20 justify-center lg:flex-row flex-col lg:justify-between">
        <div className="flex flex-col items-center lg:items-start justify-center w-full  gap-8 max-w-xl">
          ...
          <div className="flex items-center justify-start gap-4">
            <button
              ...
              className="flex items-center gap-2 bg-[#b9ff81] px-8 rounded-sm text-black text-base font-semibold py-4"
            >
        ...
        <img
          ...
          alt="hero"
          className="w-full hidden lg:block max-w-md aspect-square object-cover object-center shadow-lg rounded-md"
          loading="lazy"
        />
      </div>
    </section>
